...
# Slug: pilot_findings_closure_v4
# Delay between sessions: 120s
# Manual stop: tmux kill-session -t autoloop-pilot_findings_closure_v4

set -u
cd "$(dirname "$0")/../.." || exit 1

TRACKER=".claude/initiative-tracker-pilot_findings_closure_v4.md"
LOG=".claude/auto-loop-pilot_findings_closure_v4.log"
DELAY=120
SPEC="spec/spec_pilot_findings_closure_v4.md"
