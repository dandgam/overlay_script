#!/bin/bash
# Auto-generated by /auto-loop-spec-long on 2026-05-27
# Spec: /home/server/bmad-orchestrator/spec/spec_wtiso-bw.md
# Slug: wtiso-bw
# Delay between sessions: 300s
# Stop conditions:
#   - Final Report appears in tracker → break
#   - 'resolution: PENDING' in last 120 lines → break (human blocker)
# Manual stop: tmux kill-session -t autoloop-wtiso-bw

set -u
cd /home/server/bmad-orchestrator || exit 1

TRACKER=".claude/initiative-tracker-wtiso-bw.md"
LOG=".claude/auto-loop-wtiso-bw.log"
DELAY=300
