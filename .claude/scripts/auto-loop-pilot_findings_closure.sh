...
TRACKER=".claude/initiative-tracker-pilot_findings_closure.md"
LOG=".claude/auto-loop-pilot_findings_closure.log"
DELAY=300
SPEC="spec/spec_pilot_findings_closure.md"
