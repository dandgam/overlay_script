...
TRACKER=".claude/initiative-tracker-wave_1a_pilot_wiring.md"
LOG=".claude/auto-loop-wave_1a_pilot_wiring.log"
DELAY=300
SPEC="spec/spec_wave_1a_pilot_wiring.md"
