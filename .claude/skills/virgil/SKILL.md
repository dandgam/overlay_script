...
- **Применяй общие правила меню** из `~/.claude/skills/888/templates/menu-ux-rules.md` (расшифровка Phase N.5 словами · `label` без англ./Q-ID/сокращений · иконка обязательна · `description` ≤6 слов или пусто). Подключение Q-260520-N7O8 от 2026-05-20.
